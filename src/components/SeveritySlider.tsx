  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center space-x-4">
        <div
          className={`w-16 h-16 rounded-full bg-gradient-to-br ${currentSeverity.color} flex items-center justify-center shadow-lg transform transition-all duration-300`}
        >
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, ${
              currentSeverity.color.split(" ")[1]
            } 0%, ${currentSeverity.color.split(" ")[3]} ${
              value * 10
